var mensData = [
    ...
    {
      image_url:
        "https://assets.ajio.com/medias/sys_master/root/20210216/RACR/602ac11a7cdb8c1f1440e7f7/-473Wx593H-460738226-blue-MODEL.jpg ",
      name: "MEN'S REEBOK TRAINING FOUNDATION PANTS  ",
      price: 1019,
      strikedoffprice: 1699,
    },
    {
      image_url:
        "hhttps://assets.ajio.com/medias/sys_master/root/20210216/RACR/602ac11a7cdb8c1f1440e7f7/-473Wx593H-460738226-blue-MODEL.jpg ",
  ...
  var box = mensData.map(function(element,index){
...
var pricestriked= document.createElement("p");
pricestriked.setAttribute("id","strike");
priceproduct.innerText= element.price;
pricestriked.innerText= element.strikedoffprice;
